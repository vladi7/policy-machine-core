...
public class SuperGraph {
    ...
    public static void check(Graph graph) throws PMException {
        ...
        graph.associate(superUA1.getID(), superOA.getID(), new OperationSet(ALL_OPERATIONS), true);
        graph.associate(superUA1.getID(), superUA2.getID(), new OperationSet(ALL_OPERATIONS), true);
    }
